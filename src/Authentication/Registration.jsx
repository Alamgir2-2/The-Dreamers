        ...
        <div className="bg-gray-100 rounded-3xl shadow-2xl shadow-green-500 overflow-hidden border border-gray-300 relative">
          <div className="p-8">
            <div className="text-center mb-8">
              ...
              <h2 className="text-3xl font-bold text-gray-800 mb-2">Join Dreamers</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="pt-2">
                <motion.button
                  ...
                  className={`w-full py-3 px-6 rounded-xl font-semibold text-white transition flex items-center justify-center ${
                    isSubmitting
